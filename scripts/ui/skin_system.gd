...
func _load_skin_config() -> void:
	skin_config = config_manager.load_json(SKIN_CONFIG_PATH)
		...
		skin_config = {
			"chess": {
				"default": {
					"name": "默认棋子皮肤",
					"description": "默认的棋子外观",
					"preview": "res://assets/skins/chess/default/preview.png",
			...
			"board": {
				"default": {
					"name": "默认棋盘皮肤",
					"description": "默认的棋盘外观",
					"preview": "res://assets/skins/board/default/preview.png",
			...
			"ui": {
				"default": {
					"name": "默认UI皮肤",
					"description": "默认的UI外观",
					"preview": "res://assets/skins/ui/default/preview.png",
