...
# class_name UIThrottleManager # Commented out
## UI节流管理器
## 负责管理UI更新频率，减少不必要的重绘，提高UI响应速度

# 节流器字典
# var _throttlers: Dictionary = {} # Commented out

# 全局节流配置
# var global_config = { # Commented out
# 	"enabled": true,           # 是否启用节流
...
# 当前帧率
# var _current_fps = 60 # Commented out
...
# static var fps_timer = 0.0 # Commented out
