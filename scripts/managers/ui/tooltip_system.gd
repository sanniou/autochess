...
extends Node
# class_name TooltipSystem # Commented out
## 工具提示系统
## 负责管理游戏中的工具提示

# 信号
# signal tooltip_shown(control: Control) # Commented out
# signal tooltip_hidden(control: Control) # Commented out

# 常量
# const TOOLTIP_DELAY = 0.5  # 显示延迟时间 # Commented out
# const TOOLTIP_OFFSET = Vector2(10, 10)  # 提示框偏移量 # Commented out

# 当前工具提示
# var current_tooltip: Control = null # Commented out

# 当前目标控件
# var current_target: Control = null # Commented out

# 显示延迟计时器
# var delay_timer: Timer = null # Commented out

# 鼠标位置
# var mouse_position: Vector2 = Vector2.ZERO # Commented out
