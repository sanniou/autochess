...
## 战斗开始事件
class BattleStartedEvent extends Event:
    ## 战斗ID
...
## 战斗结束事件
class BattleEndedEvent extends Event:
    ## 战斗ID
    var battle_id: String
...
## 治疗事件
class HealReceivedEvent extends Event:
    ## 治疗来源
    var source_entity
...
## 单位死亡事件
class UnitDiedEvent extends Event:
    ## 死亡单位
    var unit
