# DEPRECATED: This script's functionality (event type preloading)
# has been moved to scripts/core/events/global_event_bus.gd.
# This script is no longer needed and can be removed from autoloads
# and eventually deleted from the project.
extends Node
## 事件系统
## 负责初始化和管理事件系统
