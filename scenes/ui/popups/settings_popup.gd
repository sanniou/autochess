extends "res://scripts/ui/popups/base_window_popup.gd"
## 设置弹窗
## 管理游戏设置
...
func _apply_settings():
	...
	GlobalEventBus.localization.dispatch_event(LocalizationEvents.LanguageChangedEvent.new(settings_data.language,settings_data.language))
